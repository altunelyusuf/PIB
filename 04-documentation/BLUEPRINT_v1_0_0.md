...
|---|---|---|---|
| **Self-coverage** | per node, profile-INDEPENDENT | `self_coverage_checker_v1_1_0_1.py` | each ontology parses, is SHACL-conformant (and optionally DL-consistent) **standalone**, no consumed ontology merged |
